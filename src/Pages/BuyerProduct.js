...
const BuyerProducts = () => {
    ...
    const url = `http://localhost:5000/buyerproducts?email=${user?.email}`;
                        ...
                        <>
                            <section className="flex items-center h-full sm:p-16 bg-gray-900 text-gray-100">
                                <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
                                    ...
                                    <p className="text-3xl">You Didn't Buy Anything, Please Buy Something</p>
                                    <Link to="/" className="px-8 py-3 font-semibold rounded bg-violet-400 text-gray-900">Back to homepage</Link>
                                </div>
                            </section>
                            <section className="p-6 md:py-20 my-5 bg-gray-800 text-gray-100">
